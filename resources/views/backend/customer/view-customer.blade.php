                ...
                <section class="col-12 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('customers.add') }}" class="btn btn-primary btn-sm float-right"><i
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ $data->id }}">
                                        ...
                                        <td>{{ $data->address }}</td>
                                        <td>
                                            <a title="Edit" href="{{ route('customers.edit', $data->id) }}"
                                                class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>

                                            <form class="d-inline-block"
                                                action="{{ route('customers.delete', $data->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
